...
class _BudgetingPageState extends State<BudgetingPage> {
  ...
  void _initializeDefaultBudgets() {
    // Initialize with common categories + credit card payments
    _categoryBudgets.addAll({
      'Food & Dining': 800.0,
      'Transportation': 300.0,
      'Shopping': 400.0,
      'Entertainment': 200.0,
      'Bills & Utilities': 500.0,
      'Credit Card Payments': 2000.0, // Add this for your monthly payments
      'Healthcare': 300.0,
      'Groceries': 600.0,
    });
  }
  ...
  Future<void> _loadTransactionData() async {
    ...
    try {
      _firestoreService.getTransactions(userId, limit: 200).listen((transactionList) {
        setState(() {
  ...
  void _calculateCategorySpending() {
    ...
    setState(() {
      ...
      _categorySpent.addAll(categorySpending);

      // Update monthly budget calculation
      _monthlyBudget = _categoryBudgets.values.fold(0.0, (sum, amount) => sum + amount);
    });
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Category Budget Performance Chart
              ...
              ModernCard(
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(Icons.bar_chart, color: AppColors.primaryIndigo, size: 24),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: _categoryBudgets.entries.map((entry) {
                          ...
                          return _buildCategoryBar(category, budget, spent, percentage, isOverBudget);
                        }).toList(),
                      ),
                    ),
                  ],
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                'Approaching budget limit (${(progress * 100).toStringAsFixed(0)}%)',
                                style: const TextStyle(
                                  color: AppColors.warningYellow,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w500,
  ...
  Widget _buildCategoryBar(String category, double budget, double spent, double percentage, bool isOverBudget) {
    final barHeight = (percentage * 160).clamp(10.0, 180.0);
    final budgetBarHeight = 160.0;
